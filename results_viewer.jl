begin
	import Pkg
	Pkg.activate()
	using MetaGraphs, CSV, DataFrames,MolecularGraph, JLD2, MolecularGraphKernels
end
...
res = train_kgnn(synthetic_graph_data[5:40],graph_labels[5:40], lr = .001, n_epoch = 300, n_hg = 4, batch_sz = 1, p=3, size_hg = 4, train_portion = .95);
...
#jldsave(filename, compress=false; res)
