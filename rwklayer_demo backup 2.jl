...
# ╔═╡ d86aa79e-2cc9-4c48-b286-050b384d3318
function remote_calc1(model,tuple)
...
function train_model_batch_dist(class_labels, graph_vector, model, batch_sz, n, lr)
	...
	for epoch in 1:n
		...
		for batch ∈ batches
			...
			results = pmap(a -> remote_calc1(model, a), batch; on_error=identity)
...
# ╔═╡ e22e6357-1c2d-44cd-b356-debbd29c3c9b
btx_losses, btx_model = train_model_batch_dist(graph_classes[1:10],btx_featuredgraphs[1:10],make_kgnn(3,12,4,4,3), 3, 3,.1)

# ╔═╡ 8a62ac76-85f2-4cf4-abab-3cf9fedc8ae5
begin
	graph_vector = btx_featuredgraphs[1:10]
	class_labels = graph_classes[1:10]
...
# ╔═╡ cd9d9d7a-bacb-482b-8a88-e82cad97118d
oh_class

# ╔═╡ d92caa62-e512-42c6-b8f6-2eb7fa65d654
batches = Base.Iterators.partition(shuffle(collect(data_class)), 3)

# ╔═╡ 46d0a6fc-3fb0-4c8c-a070-e394c0678989
ata = ["a", "b", "c", "d", "e", "f", "g"]

# ╔═╡ e6d2b969-4230-4001-a877-dab708bd05d4
lass = [
	0 1 1 1 0 1 0
	]

# ╔═╡ 9e3617d8-345f-4f15-be80-1c9d48be5b3a
[lass[:,n] for n ∈ 1:7]

# ╔═╡ 54bd1d92-be9d-4378-90d5-f451e2726a03
first(zip(ata, ))
...
result = [remote_calc(make_kgnn(3,12,4,4,1),btx_featuredgraphs[1],[Float32(1.0), Float32(0.0)]) for i ∈ 1:5]

# ╔═╡ 4267cd62-3c4d-427f-81c3-b2b8ff8e5b2d
[result[i].loss for i ∈ 1:5]

# ╔═╡ a5364336-2492-44cb-b7da-f860c1e89ef4
[result[i].grads for i ∈ 1:5]

# ╔═╡ c9cda9d5-10b2-422b-83fb-3ae56856d44b
graph_classes[1]
